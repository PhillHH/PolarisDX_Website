...
const replacements = {
  de: [
    ...
    {
      search: '48-Stunden-Remote-Setup-Service',
      replace: 'Remote-Setup-Service innerhalb von 3-5 Werktagen',
    },
  ...
  en: [
    ...
    {
      search: '48-hour remote setup service',
      replace: 'remote setup service within 3-5 business days',
    },
  ...
  fr: [
    ...
    {
      search: 'configuration à distance en 48 heures',
      replace: 'configuration à distance en 3-5 jours ouvrés',
    },
  ...
  it: [
    ...
    {
      search: 'configurazione remota in 48 ore',
      replace: 'configurazione remota in 3-5 giorni lavorativi',
    },
    {
      search: 'messa in servizio in 48 ore',
      replace: 'messa in servizio in 3-5 giorni lavorativi',
    },
  ],
  pl: [
    { search: '48h', replace: '3-5 dni roboczych' },
    {
      search: '48-godzinnej zdalnej konfiguracji',
      replace: 'zdalnej konfiguracji w 3-5 dni roboczych',
    },
  ...
  es: [
    ...
    {
      search: 'configuración remota de 48 horas',
      replace: 'configuración remota en 3-5 días hábiles',
    },
  ...
  da: [
    ...
    {
      search: '48-timers remote setup service',
      replace: 'remote setup service inden for 3-5 arbejdsdage',
    },
  ...
  nl: [
    ...
    {
      search: '48-uurs remote setup service',
      replace: 'remote setup service binnen 3-5 werkdagen',
    },
