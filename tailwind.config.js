  ...
  theme: {
    extend: {
      colors: {
        ...
        // Zweiter Name derselben Navy. Die Preview kennt nur `text-heading`,
        // dieser Stand nur `text-text-heading` - ein Baustein, der von dort
        // herueberkommt, verlor damit stillschweigend seine Farbe.
        heading: '#083358',
