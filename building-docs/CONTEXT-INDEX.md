...
| **AP04** | Content-Strategie, Content-Modell, Launch-Readiness        | I18N-CONTRACT · SEO-CONTRACT · CONTENT-ASSET-CONTRACT                                                                            | QUALITY-GATES · ROUTING-CONTRACT                                                     | Content-Typen und Readiness sind an Sprach- und Metadaten-Parität gebunden.                         |
...
| **AP21** | Consumer-Landingpages × 10 Sprachen                        | ROUTING-CONTRACT · SEO-CONTRACT · I18N-CONTRACT · LEAD-DATA-CONTRACT · QUALITY-GATES                                             | CONSENT-CONTRACT · TRACKING-CONTRACT · BACKEND-API-CONTRACT · CONTENT-ASSET-CONTRACT | Indexierbar (kein `noindex`), sehr hohe Performance-/SEO-Anforderung, Ordering-Pfad.                |
