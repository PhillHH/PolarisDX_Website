> ## Einordnung dieses Dokuments (Header-Notiz, hinzugefügt beim Aufnehmen in `building-docs/`)
>
> **Was dies ist:** Repository-Evidenz / Ist-Zustands-Analyse des Repositories vom 2026-08-21.
> Es beschreibt den gemessenen technischen Zustand — Git-State, Toolchain, Struktur, Deployment-Topologie,
> Dokumentations-Drift und Risiken.
>
> **Was dies NICHT ist:** eine Scope- oder Baseline-Entscheidung.
>
> **§11 „Recommended Baseline for Relaunch Work" ist NICHT AUTORITATIV.**
> Der dortige Vorschlag, `main@d0fdf29` als technisch neuere Baseline zu verwenden, ist überholt und
> wird nicht angewendet. Verbindlich ist ausschließlich die im Master-Scope festgeschriebene Baseline:
>
> **`feat/home-leadmagnet@961f65d`** (`building-docs/scope/MASTER-SCOPE.md`, Kopfzeile „Repository-Baseline"
> sowie DEC-Prinzip 1.2/1: _„Baseline ist `feat/home-leadmagnet@961f65d`. Andere Branches sind selektive
> Quellen, keine Gegenentwürfe."_).
>
> Bei jedem Konflikt zwischen diesem Dokument und dem Master-Scope gewinnt der Master-Scope
> (siehe `building-docs/PROJECT-CONSTRAINTS.md`, „Autoritätsreihenfolge").
>
> Der übrige faktische Inhalt unten ist unverändert und bleibt als Repository-Evidenz gültig.
