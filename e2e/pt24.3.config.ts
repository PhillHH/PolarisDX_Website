...
/**
 * PT24.3 — Fokus. Gemessen wird gegen den Dev-SSR-Server, NICHT gegen einen
 * Produktionsbuild: Fast-Delta V2 verbietet in PT24.1–PT24.5 den vollen Build,
 * und Fokusdarstellung haengt an CSS und Fokusverwaltung, nicht an der
 * Buendelung. Dieselben Komponenten, dasselbe DOM, derselbe Browser.
 *
 * `retries: 0` bleibt bewusst: ein Fokustest, der erst im zweiten Anlauf gruen
 * wird, hat ein Zeitproblem, das man sehen soll.
 *
