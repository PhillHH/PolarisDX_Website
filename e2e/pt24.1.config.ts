...
/**
 * PT24.1 — Semantik. Gemessen wird gegen den Dev-SSR-Server, NICHT gegen einen
 * Produktionsbuild: Fast-Delta V2 verbietet in PT24.1–PT24.5 den vollen Build,
 * und fuer Dokumentstruktur — Landmarks, Ueberschriften, Labels, Fehler- und
 * Statusbeziehungen — macht der Build keinen Unterschied. Dieselben Komponenten,
 * dasselbe DOM.
 *
