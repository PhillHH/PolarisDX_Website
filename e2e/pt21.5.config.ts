 ...
 *
 * Gemessen wird die BESTELLSTRECKE im Browser: Consent-Unabhaengigkeit,
 * Pre-Consent-Providerrequests, Double-Submit, allowlistete Nutzlast und
 * die x10-Systemcopy. Die Endpunktwahrheit (Persistenz, Idempotenz, Retry,
 * Rate Limit) liegt in `server/consumer-order*.test.js`; hier wird
 * `/api/consumer-order` abgefangen, damit der Client isoliert messbar ist.
 *
...
const clientOutDir = 'node_modules/.cache/pt21-5/client'
const serverOutDir = 'node_modules/.cache/pt21-5/server'
const build =
