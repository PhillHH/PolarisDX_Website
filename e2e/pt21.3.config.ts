...
const clientOutDir = 'node_modules/.cache/pt21-3/client'
const serverOutDir = 'node_modules/.cache/pt21-3/server'
const build =
...
export default defineConfig({
  testDir: '.',
  testMatch: 'consumer-masks.spec.ts',
  timeout: 90_000,
  fullyParallel: false,
  retries: 0,
  workers: 1,
