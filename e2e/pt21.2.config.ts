...
const clientOutDir = 'node_modules/.cache/pt21-2/client'
const serverOutDir = 'node_modules/.cache/pt21-2/server'
const build =
...
export default defineConfig({
  testDir: '.',
  testMatch: 'consumer-spray.spec.ts',
  timeout: 90_000,
  fullyParallel: false,
  retries: 0,
  workers: 1,
