...
export const agbData = {
  ...
  sections: [
    ...
    {
      id: "section-5",
      title: "§ 5 Gewaehrleistung und Maengelansprueche",
      content: [
    ...
    {
      id: "section-6",
      title: "§ 6 Haftung und Haftungsbeschraenkung",
      content: [
    ...
    {
      id: "section-8",
      title: "§ 8 Nutzungsrechte an Software & Cloud-Diensten",
      content: [
    ...
    {
      id: "section-9",
      title: "§ 9 Sperrung bei Zahlungsverzug",
      content: [
    ...
    {
      id: "section-10",
      title: "§ 10 Ruecktritt, Rueckforderung & Widerruf der Nutzung",
      content: [
    ...
    {
      id: "section-11",
      title: "§ 11 Ausschluss der Rueckgabe bei Inbetriebnahme von Medizinprodukten",
      content: [
    ...
    {
      id: "section-12",
      title: "§ 12 Produktkonformitaet und regulatorische Anforderungen",
      content: [
    ...
    {
      id: "section-13",
      title: "§ 13 Vigilanz und Meldepflichten",
      content: [
    ...
    {
      id: "section-14",
      title: "§ 14 Qualitaetssicherung und Dokumentation",
      content: [
    ...
    {
      id: "section-15",
      title: "§ 15 Schulung und technischer Support",
      content: [
    ...
    {
      id: "section-16",
      title: "§ 16 Wartung und Instandhaltung",
      content: [
    ...
    {
      id: "section-17",
      title: "§ 17 Software-Updates und Upgrades",
      content: [
    ...
    {
      id: "section-18",
      title: "§ 18 Datenschutz und Datensicherheit",
      content: [
    ...
    {
      id: "section-19",
      title: "§ 19 Geheimhaltung und Vertraulichkeit",
      content: [
    ...
    {
      id: "section-21",
      title: "§ 21 Exportkontrolle und Sanktionen",
      content: [
    ...
    {
      id: "section-22",
      title: "§ 22 Vertragslaufzeit und Kuendigung",
      content: [
    ...
    {
      id: "section-23",
      title: "§ 23 Streitbeilegung und Gerichtsstand",
      content: [
