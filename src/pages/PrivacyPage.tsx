      ...
      <div className="pt-32 pb-16 lg:pt-48 lg:pb-32 bg-surface-base">
        <div className="mx-auto max-w-container px-4 lg:px-0">
          <Reveal width="100%" yOffset={20}>
            <h1 className="text-3xl font-bold mb-8 text-ink">{t('privacy.title')}</h1>
          </Reveal>

          <Reveal width="100%">
            <div className="space-y-8 text-ink-muted bg-surface-raised p-8 rounded-2xl border border-line-subtle shadow-sm text-sm leading-relaxed sm:text-base">
              <section>
                ...
                <h3 className="font-semibold mt-4 mb-2">
                  {t('privacy.section1.collection.title')}
                </h3>
                <p>
              ...
              <section>
                ...
                <h3 className="font-semibold mt-4 mb-2">
                  {t('privacy.section3.protection.title')}
                </h3>
                <p>{t('privacy.section3.protection.content')}</p>

                <h3 className="font-semibold mt-4 mb-2">
                  {t('privacy.section3.responsible.title')}
                </h3>
                <p>{t('privacy.section3.responsible.content')}</p>
                <p className="mt-2">
                  {(
                    t('privacy.section3.responsible.address', { returnObjects: true }) as string[]
                  ).map((line, idx) => (
                    <span key={idx}>
                      {line}
                      <br />
