 ...
 * Der prominente obere Bereich der Startseite (Above the Fold).
 * Enthält Titel, Untertitel, CTAs und wichtige Statistiken sowie ein Hero-Bild auf Desktop.
 */
const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* Dekorative Hintergrund-Gradienten */}
      ...
      <div className="relative z-10 mx-auto flex min-h-[490px] max-w-container items-stretch px-4 pt-10 pb-0 lg:px-0 lg:pt-14 lg:pb-0">
        <div className="grid w-full gap-4 lg:grid-cols-[minmax(0,1.3fr)_minmax(0,1fr)]">
          ...
          {/* Rechte Spalte: Bildbereich (nur Desktop) */}
