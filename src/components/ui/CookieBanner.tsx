      ...
      <div className="max-w-7xl mx-auto flex flex-col gap-4">
        ...
        <div className="flex flex-col md:flex-row gap-4 items-start md:items-center justify-between">
          <div className="flex gap-4 items-start">
            <div className="p-2 bg-accent-soft rounded-lg text-accent hidden md:block">
              <Shield size={24} />
            </div>
            <div>
        ...
        {/* Settings Panel */}
        {showSettings && (
          <div className="mt-4 border-t border-[var(--color-border)] pt-4 animate-in fade-in duration-200">
                ...
                <div
                  ...
                  className={`p-4 rounded-lg border ${
                    category.enabled
                      ...
                      : 'border-[var(--color-border)] bg-bg-subtle/50'
                  }`}
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <label className="relative inline-flex items-center cursor-pointer">
                      ...
                      />
                      <div
                        className={`w-11 h-6 bg-[var(--color-border)] peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-[var(--color-focus-ring)] rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-[var(--color-fg-on-dark)] after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-surface after:border-[var(--color-border-strong)] after:border after:rounded-full after:h-5 after:w-5 after:transition-all ${
