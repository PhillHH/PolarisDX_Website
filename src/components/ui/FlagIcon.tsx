...
const flags: Record<string, ReactNode> = {
  ...
  gb: (
    <svg viewBox="0 0 640 480" xmlns="http://www.w3.org/2000/svg">
      ...
      <path
        fill="#fff"
        d="m75 0 244 181L562 0h78v62L400 241l240 178v61h-80L320 301 82 480H0v-60l239-178L0 64V0h75z"
      />
      <path
        fill="#C8102E"
...
const FlagIcon = ({ countryCode, className = '' }: FlagIconProps) => {
  ...
  if (!flag) {
    ...
    return (
      <span
        className={`inline-flex items-center justify-center bg-gray-200 text-xs font-semibold text-gray-600 uppercase ${className}`}
      >
        {countryCode}
      </span>
    )
