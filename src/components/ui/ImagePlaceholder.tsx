 ...
 *  - hell  (Default): bg-slate-100 border-slate-300 text-slate-600
...
const ImagePlaceholder = ({ label, className }: ImagePlaceholderProps) => {
  return (
    <div
      ...
      className={cn(
        'flex flex-col items-center justify-center gap-2 rounded-xl border border-dashed text-center select-none bg-slate-100 border-slate-300 text-slate-600',
        className,
      )}
    >
